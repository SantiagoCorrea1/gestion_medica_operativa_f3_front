...
export const demoEvents: TimeSlot[] = [
  { idDisponibilidad: 'evt_001', nombreEspecialidad: 'Cardiología', numeroConsultorio: 'Cons. A-1', horaFranja: '09:00 - 09:45', nombreProfesional: 'Dr. García Mendoza', activa: true, date: '2024-01-15' },
  { idDisponibilidad: 'evt_002', nombreEspecialidad: 'Neurología', numeroConsultorio: 'Cons. B-2', horaFranja: '10:30 - 11:30', nombreProfesional: 'Dra. Martínez Silva', activa: false, date: '2024-01-15' },
  { idDisponibilidad: 'evt_003', nombreEspecialidad: 'Pediatría', numeroConsultorio: 'Pediátrico', horaFranja: '14:00 - 14:30', nombreProfesional: 'Dr. Rodríguez', activa: true, date: '2024-01-16' },
  { idDisponibilidad: 'evt_004', nombreEspecialidad: 'Medicina General', numeroConsultorio: 'Cons. A-3', horaFranja: '08:00 - 12:00', nombreProfesional: 'BLOQUEO', activa: false, date: '2024-01-16' },
  { idDisponibilidad: 'evt_005', nombreEspecialidad: 'Ginecología', numeroConsultorio: 'Cons. C-1', horaFranja: '15:30 - 16:00', nombreProfesional: 'Dra. Santos López', activa: false, date: '2024-01-17' },
];
