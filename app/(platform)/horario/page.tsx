...
import { useAllTimeSlots } from '@/hooks/timeSlotHooks';
...
export default function HorarioPage() {
  ...
  const {data: timeSlots, isLoading} = useAllTimeSlots();
  ...
  return (
    <TimeSlotManager timeSlots={timeSlots ?? []} isLoading={isLoading} isDemoData={isDemoData} />
  );
}